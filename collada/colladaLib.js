  ...
  class ColladaLibLoader extends Loader
  {
    ...
    parse(text, path)
    {
      ...
      if (asset.upAxis === 'Z_UP')
      {
        ...
        console.warn('ColladaLoader: You are loading an asset with a Z-UP coordinate system. The loader just rotates the asset to transform it into Y-UP. The vertex data are not converted, see #24289.');
      ...
      return {
        get animations()
        {
          ...
          console.warn('ColladaLoader: Please access animations over scene.animations now.');
          return animations;
