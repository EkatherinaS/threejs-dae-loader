...
(() => {
  ...
  class ColladaLibLoader extends Loader {
    ...
    parse(text, path) {
      ...
      function buildMaterial(data) {
        ...
        function getTexture(textureObject, colorSpace = null) {
          ...
          if (sampler !== undefined) {
            ...
            console.warn(
              "ColladaLoader: Undefined sampler. Access image directly (see #12530)."
            );
          ...
          if (image !== null) {
            ...
            if (loader !== undefined) {
              ...
              console.warn(
                "ColladaLoader: Loader for texture %s not found.",
                image
              );
            ...
            console.warn(
              "ColladaLoader: Couldn't create texture with ID:",
              textureObject.id
            );
        ...
        if (transparent && transparency) {
          ...
          if (transparent.data.texture) {
            ...
            switch (transparent.opaque) {
              ...
              default:
                console.warn(
                  'ColladaLoader: Invalid opaque type "%s" of transparent tag.',
                  transparent.opaque
                );
            }
      ...
      function parseGeometry(xml) {
        ...
        // the following tags inside geometry are not supported yet (see https://github.com/mrdoob/js/pull/12606): convex_mesh, spline, brep
        if (mesh === undefined) {
          return;
        }
      ...
      function buildGeometryType(primitives, sources, vertices) {
        ...
        for (let p = 0; p < primitives.length; p++) {
          ...
          switch (primitive.type) {
            ...
            default:
              console.warn(
                "ColladaLoader: Unknow primitive type:",
                primitive.type
              );
          }
      ...
      function buildSkeleton(skeletons, joints) {
        ...
        for (i = 0; i < skeletons.length; i++) {
          ...
          if (hasNode(skeleton)) {
            ...
            console.error(
              "ColladaLoader: Unable to find root bone of skeleton with ID:",
              skeleton
            );
          }
        }
      ...
      function resolveMaterialBinding(keys, instanceMaterials) {
        ...
        for (let i = 0, l = keys.length; i < l; i++) {
          ...
          if (id === undefined) {
            console.warn(
              "ColladaLoader: Material with key %s not found. Apply fallback material.",
              keys[i]
            );
      ...
      console.debug("ColladaLoader: File version", version);
      ...
      if (TGALibLoader) {
        TGALibLoader = new TGALibLoader(this.manager);
        TGALibLoader.setPath(this.resourcePath || path);
      }
      ...
      if (asset.upAxis === "Z_UP") {
        console.warn(
          "ColladaLoader: You are loading an asset with a Z-UP coordinate system. The loader just rotates the asset to transform it into Y-UP. The vertex data are not converted, see #24289."
        );
      ...
      return {
        get animations() {
          console.warn(
            "ColladaLoader: Please access animations over scene.animations now."
          );
          return animations;
        },
  ...
  window.ColladaLibLoader = ColladaLibLoader;
})();
